package com.example.application.views.richtexteditorjava;
...
@PageTitle("Rich Text Editor (Java)")
@Route(value = "editor-view", layout = MainLayout.class)
public class RichTextEditorJavaView extends Main {

    public RichTextEditorJavaView() {
