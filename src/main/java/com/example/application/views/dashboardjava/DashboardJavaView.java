...
import com.example.application.views.dashboardjava.ServiceHealth.Status;
...
@PageTitle("Dashboard (Java)")
@Route(value = "dashboard-view", layout = MainLayout.class)
public class DashboardJavaView extends Main {

    public DashboardJavaView() {
        addClassName("dashboard-java-view");
