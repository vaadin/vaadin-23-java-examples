package com.example.application.views.cardlistjava;
...
@PageTitle("Card List (Java)")
@Route(value = "card-list-view", layout = MainLayout.class)
public class CardListJavaView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public CardListJavaView() {
        addClassName("card-list-java-view");
        setSizeFull();
        grid.setHeight("100%");
