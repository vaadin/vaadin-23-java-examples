...
@PageTitle("Address Form (Java)")
@Route(value = "address-form-view", layout = MainLayout.class)
public class AddressFormJavaView extends Div {
    ...
    public AddressFormJavaView(SampleAddressService addressService) {
        addClassName("address-form-java-view");
