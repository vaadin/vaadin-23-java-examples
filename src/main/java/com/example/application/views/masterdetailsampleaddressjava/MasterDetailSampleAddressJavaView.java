package com.example.application.views.masterdetailsampleaddressjava;
...
@PageTitle("Master-Detail SampleAddress (Java)")
@Route(value = "master-detail-view-sampleaddress/:sampleAddressID?/:action?(edit)", layout = MainLayout.class)
public class MasterDetailSampleAddressJavaView extends Div implements BeforeEnterObserver {
    ...
    public MasterDetailSampleAddressJavaView(SampleAddressService sampleAddressService) {
        this.sampleAddressService = sampleAddressService;
        addClassNames("master-detail-sample-address-java-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(MasterDetailSampleAddressJavaView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleAddressId.isPresent()) {
            ...
            if (sampleAddressFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(MasterDetailSampleAddressJavaView.class);
            }
        }
    }
