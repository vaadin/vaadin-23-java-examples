...
@PageTitle("Chat (Java)")
@Route(value = "chat-view", layout = MainLayout.class)
public class ChatJavaView extends HorizontalLayout {
    ...
    public ChatJavaView() {
        addClassNames("chat-java-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
