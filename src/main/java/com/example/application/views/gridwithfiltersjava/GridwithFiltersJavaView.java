...
@PageTitle("Grid with Filters (Java)")
@Route(value = "grid-with-filters-view", layout = MainLayout.class)
@Uses(Icon.class)
public class GridwithFiltersJavaView extends Div {
    ...
    public GridwithFiltersJavaView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("gridwith-filters-java-view");
