package com.example.application.views.listjava;
...
@PageTitle("List (Java)")
@Route(value = "list-view", layout = MainLayout.class)
public class ListJavaView extends Div {
